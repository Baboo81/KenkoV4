    ...
    <div class="container">
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-md-6 d-none d-md-flex justify-content-center">
                <img src="{{ asset('assets/img/form/contact.svg') }}"
                ...
                <form class="rounded-4 shadow-lg p-4 bg-light" action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="message" name="message" rows="5" placeholder="Laissez-moi votre message" required></textarea>
                        </div>
                    </div>
